...
const StockCenterContainer = () => {
    ...
    let text
    if(strainList && plasmidList) {
        let temp = <div className={classes.plusSign}><FontAwesomeIcon icon="plus" /></div>
        text = strainList.concat(temp)
        text = text.concat(plasmidList)
        text.concat(temp)
    }
