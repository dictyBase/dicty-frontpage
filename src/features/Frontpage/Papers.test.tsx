...
describe("feature/Frontpage/Papers Browser based", () => {
  ...
  it("should render papers", () => {
    ;(useListRecentPublicationsQuery as jest.Mock).mockReturnValue({
      ...
      expect(screen.getByText("Tanaka, Jahan, Kondo, Nakano & Yumura (2019)")).toBeInTheDocument()
      expect(screen.getByText("Cytokinesis D is Mediated by Cortical Flow of Dividing Cells Instead of Chemotaxis.")).toBeInTheDocument()
