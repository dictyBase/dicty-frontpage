...
const fetchDownloadTabsSuccess = (json) => ({
...
const fetchDownloadContentSuccess = (id, json) => ({
...
const fetchDownloadTabs = () => async (dispatch) => {
  try {
...
const fetchDownloadContent = (id, url) => async (dispatch) => {
  try {
