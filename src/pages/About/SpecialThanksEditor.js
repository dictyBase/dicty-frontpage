...
const initialValue = Value.fromJSON(existingValue || specialThanks)
...
export default class SpecialThanksEditor extends Component {
  state = {
  ...
  onSave = () => {
    ...
    localStorage.setItem("contentRight", content)
    this.setState(this.state.value)
