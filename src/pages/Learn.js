        ...
        <Flex wrap>
            ...
            <Container>
                ...
                <SectionBox id="About">
                    ...
                    <p>
                        The ameboid protozoan <em>Dictyostelium discoideum</em> is a powerful system for genetic and functional analysis of gene function. The 34 Mb genome contains many genes that are homologous to those in higher eukaryotes and are missing in <em>Saccharomyces cerevisiae</em>.  The organism is uniquely suited for studing cytokinesis, cell motility, phagocytosis, chemotaxis, signal transduction, and cell differentiation during development.  Many of these processes, which play important roles in health and disease, are either absent or are less accessible in other model organisms.
                    </p>
                    <p>
                        <em>Dictyostelium</em> amoebae grow as separate, independent cells but interact to form multicellular structures when challenged by adverse conditions such as starvation. Up to 100,000 cells signal each other by releasing the chemoattractant cAMP and aggregate together by chemotaxis to form a mound that is surrounded by an extracellular matrix. This mechanism for generating a multicellular organism differs radically from the early steps of metazoan embryogenesis. However, subsequent processes depend on cell-cell communication in both <em>Dictyostelium</em> and metazoans. Many of the underlying molecular and cellular processes appear to have arisen in primitive precursor cells and to have remained fundamentally unchanged throughout evolution. Basic processes of development such as differential cell sorting, pattern formation, stimulus-induced gene expression, and cell-type regulation are common to <em>Dictyostelium</em> and metazoans. <Link href="">This figure</Link> shows the vegetative, developmental, and sexual life cycles of <em>D. discoideum</em>.
                    </p>
                ...
                <SectionBox id="Community">
                    ...
                    <p>
                        ...
                        <em>D. discoideum</em> is one of the model organisms chosen by the National Institutes of Health as part of its <Link href="">Model Organism Initiative</Link>. dictyBase's Colleague database contains over 1100 researchers and our weekly newsletter goes to nearly 600 researchers around the world. This active community has had an annual scientific meeting every year since 1983, typically attended by over 150 investigators. Around 200 publications involving <em>Dictyostelium</em> appear each year in peer reviewed journals and as of 2010 the NIH RePORTER Database lists 87 funded research grants using <em>Dictyostelium</em>.
                    </p>
                    <Link href="#"><TopLink>Top</TopLink></Link>
                </SectionBox> 
                <SectionBox id="Focus">
                ...
                <SectionBox id="Education">
                    ...
                    <p>
                        Dictyostelium is popular in educational settings because of its interesting and visually striking life cycle, which can be readily observed with simple equipment. Because of the ability to grow Dictyostelium at room temperature, using relatively inexpensive media, a large number of laboratory exercises have been developed using Dictyostelium, several of which are available on dictyBase's <Link href="/explore/teach">Teaching Tools Using <em>Dictyostelium discoideum</em></Link> page.
                    </p>
                    <Link href="#"><TopLink>Top</TopLink></Link>
                </SectionBox>   
                <SectionBox id="Techniques">
                    <h3>Available techniques</h3>
                        <p>
                            <em>Dictyostelium</em> is a powerful model system to study important biomedical problems. Numerous molecular genetics techniques, including gene knock-out, gene knock-in, restriction enzyme-mediated mutagenesis, RNAi, and inducible gene expression, allow a wide range of biological questions to be tested. The dictybase <Link href="">Techniques</Link> pages contain protocols for many widey used methods.
                        </p>

                        <h4>Phenotypic studies</h4>
                        <p>
                            The simplicity of the life cycle facilitates mutant selection. The growth and developmental stages are completely independent, and switching between the two states is achieved by removing nutrients. Many mutations can be screened by clonally plating cells on bacterial lawns. As the amoebae grow, they ingest the bacteria and form a plaque. The cells within the plaque starve and enter the developmental program. Aberrant phenotypes can be scored by visual inspection of the plaques. 
                            <SectionImgLeft src={techniqueimg1}/>
                            Since the early stages of development are readily reversible, mutants can be selected and then propagated by returning them to nutrients. Strains are preserved in liquid nitrogen and can be recovered by scraping some frozen cells directly onto a lawn of bacteria or into axenic medium. Spores remain viable on silica gel at -20° C for 5-10 years and for longer when lyophilized. The <Link href="">Nomenclature Guidelines</Link> describe how to name strains and alleles.
                        </p>
                        <p>
