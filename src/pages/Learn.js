            ...
            <Container>
                ...
                <SectionBox id="Community">
                    ...
                    <p>
                        ...
                        <em>D. discoideum</em> is one of the model organisms chosen by the National Institutes of Health as part of its Model Organism Initiative. dictyBase's Colleague database contains over 1100 researchers and our weekly newsletter goes to nearly 600 researchers around the world. This active community has had an annual scientific meeting every year since 1983, typically attended by over 150 investigators. Around 200 publications involving <em>Dictyostelium</em> appear each year in peer reviewed journals and as of 2010 the NIH RePORTER Database lists 87 funded research grants using <em>Dictyostelium</em>.
                    </p>
                    <Link href="#"><TopLink>Top</TopLink></Link>
                </SectionBox> 
                <SectionBox id="Focus">
                ...
                <SectionBox id="Techniques">
                    <h3>Available techniques</h3>
                        <p>
                            <em>Dictyostelium</em> is a powerful model system to study important biomedical problems. Numerous molecular genetics techniques, including gene knock-out, gene knock-in, restriction enzyme-mediated mutagenesis, RNAi, and inducible gene expression, allow a wide range of biological questions to be tested. The dictybase <Link>Techniques</Link> pages contain protocols for many widey used methods.
                        </p>
                        ...
                        <p>
                            ...
                            Since the early stages of development are readily reversible, mutants can be selected and then propagated by returning them to nutrients. Strains are preserved in liquid nitrogen and can be recovered by scraping some frozen cells directly onto a lawn of bacteria or into axenic medium. Spores remain viable on silica gel at -20° C for 5-10 years and for longer when lyophilized. The <Link>Nomenclature</Link> Guidelines describe how to name strains and alleles.
                        </p>
                        <p>
